...
float Plane::stabilize_roll_get_roll_out()
{
    ...
    return rollController.run_angle_control(nav_roll_cd, speed_scaler, disable_integrator, freeze_integrator,
...
float Plane::stabilize_pitch_get_pitch_out()
{
    ...
    */
    ...
    return pitchController.run_angle_control(demanded_pitch, speed_scaler, disable_integrator, freeze_integrator,
                                         ground_mode && !(plane.flight_option_enabled(FlightOptions::DISABLE_GROUND_PID_SUPPRESSION)));
}
