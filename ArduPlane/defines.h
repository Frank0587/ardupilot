...
#define KTW_UPPOS       (0.80f) // 80% set to raise the KTW in case of auto throttle
#define KTW_LIMITPOS    (0.70f) // 70% under this limit prevent Motor
#define KTW_SLEW        (0.70f) // 70%/sec for full movement
