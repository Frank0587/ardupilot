...
typedef enum REBOOT_SHUTDOWN_ACTION
{
   ...
   REBOOT_SHUTDOWN_ACTION_REBOOT_TO_MASS_STORAGE=5, /* Reboot component into a mass storage mode if supported. | */
